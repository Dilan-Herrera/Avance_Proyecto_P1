...
namespace Avance_Proyecto_P1.Controllers
{
    public class PagoesController : Controller
    {
        ...
        public PagoesController(Avance_Proyecto_P1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FechaPago,Monto,Metodo")] Pago pago)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FechaPago,Monto,Metodo")] Pago pago)
        {
            if (id != pago.Id)
            {
                return NotFound();
